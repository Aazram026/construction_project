    ...
    <div class="header-wrapper">
        <div class="container">
            ...
            <div class="logo">
                ...
                <a href="http://localhost:81/construction_re/cost-estimation/main/cost.html" class="btn btn-theme-transparent -align-right" >
                    <i class="fa fa-money"></i>
                    <span class="hidden-sm hidden-xs"><?php echo translate('cost-estimation'); ?></span>
                </a>
            </div>
            ...
            <div class="header-search">
                ...
                ?>
                    ...
                    <select
                        ...
                        <option value="vendor"><?php echo translate('Supplier');?></option>                    
                    </select>
                    <?php
						}
					?>
                ...
                <ul class="nav sf-menu">
                    ...
                    <li <?php if($asset_page=='all_vendor'){ ?>class="active"<?php } ?>>
                        <a href="<?php echo base_url(); ?>home/all_vendor/">
                            <?php echo translate('all_Suppliers');?>
                        </a>
                    </li>
                    <?php
                                }
                    ...
                    <li class="hidden-sm hidden-xs <?php if($asset_page=='blog'){ echo 'active'; } ?>">
                        <a href="<?php echo base_url(); ?>home/blog">
                            <?php echo translate('Contractors');?>
                        </a>
                        <ul>
                        	<?php
