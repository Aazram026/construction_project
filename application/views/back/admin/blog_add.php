                    ...
                    <div class="tab-content">
                        ...
                        <div id="blog_details" class="tab-pane fade active in">
                            ...
                            <div class="form-group btm_border">
                                <h4 class="text-thin text-center"><?php echo translate('Contractor_details'); ?></h4>                            
                            </div>

                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-1"><?php echo translate('Contractor_title');?></label>
                                <div class="col-sm-6">
                                    <input type="text" name="title" id="demo-hor-1" placeholder="<?php echo translate('Contractor_title');?>" class="form-control required">
                                </div>
                            </div>
                            ...
                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-1"><?php echo translate('Contractor_NTN');?></label>
                                <div class="col-sm-6">
                                    <input type="text" name="author" id="demo-hor-1" placeholder="<?php echo translate('Contractor_NTN');?>" class="form-control ">
                                </div>
                            </div>

                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-1"><?php echo translate('Profile_Update_Date');?></label>
                                <div class="col-sm-6">
