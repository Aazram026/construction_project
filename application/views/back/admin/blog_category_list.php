			...
			<tr>
				...
				<td class="text-right">
					<a class="btn btn-success btn-xs btn-labeled fa fa-wrench" data-toggle="tooltip" 
                    	onclick="ajax_modal('edit','<?php echo translate('Contractor_type_edit'); ?>','<?php echo translate('successfully_edited!'); ?>','Contractor_type_edit','<?php echo $row['blog_category_id']; ?>')" 
	...
	<div id='export-div'>
		<h1 style="display:none;"><?php echo translate('Contractor_Type'); ?></h1>
